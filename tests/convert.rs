...
fn convert_raw_to_qcow2_passes_qemu_check() {
    ...
    converter::convert_from_raw(&raw_path, &qcow2_path, false).unwrap();
...
fn convert_raw_to_qcow2_compressed_passes_qemu_check() {
    ...
    converter::convert_from_raw(&raw_path, &qcow2_path, true).unwrap();
...
fn convert_qcow2_to_qcow2_passes_qemu_check() {
    ...
    converter::convert_qcow2_to_qcow2(&src, &dst, false).unwrap();
...
fn convert_qcow2_to_qcow2_compressed_passes_qemu_check() {
    ...
    converter::convert_qcow2_to_qcow2(&src, &dst, true).unwrap();
